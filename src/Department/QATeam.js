...
export const QATeam = () => {
    ...
    const [filtereddData, setFilterdddata] = useState([department.departmentUser]);


    useEffect(() => {
        dispatch(GetDepartmentData(6))
        dispatch(GetCordinatorlist())
        dispatch(GetManagerlist())
        dispatch(GetUserList(6))
    ...
    const editHandler = (id) => {
        setEditData(filtereddData.filter((fl) => fl.id === id));
        setSelectedId(id);
        setIsPost(false);
        handleShow()
    };
                ...
                <div className="pagetitle">
                    ...
                    <nav>
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active">QA Team</li>
                        </ol>
                    </nav>
                </div>{/* End Page Title */}
                                                    ...
                                                    {filtereddData.map((data, i) => (
                                                        ...
                                                        <tr key={data.id}
                                                            ...
                                                            <td><i className="ri-edit-2-fill" data-bs-toggle="tooltip"
                                                                data-bs-placement="bottom" title="Edit " onClick={() => editHandler(data.id)} style={{ cursor: "pointer" }} />&nbsp;
                                                            </td>
                                                        </tr>
                    ...
                    >
                        {({ errors, touched, values, handleChange, handleBlur }) => (
                            <Form autoComplete='off'>
                                ...
                                <div className="form-group">
                                    <label htmlFor="PC">Availability</label>
                                    <select
                                        name='avail'
                                        id='avail'
                                        className='form-control input-default mt-2'
