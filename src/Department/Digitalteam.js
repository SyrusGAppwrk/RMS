...
export const Digitalteam = () => {
    ...
    const [Filterddata, setFilterddata] = useState([department.departmentUser]);
    ...
    const editHandler = (id) => {
        setEditData(Filterddata.filter((fl) => fl.id === id));
        setSelectedId(id);
        setIsPost(false);
        handleShow()
    };
                ...
                <div className="pagetitle">
                    ...
                    <nav>
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active">Digital Team</li>
                        </ol>
                    </nav>
                </div>{/* End Page Title */}
                    ...
                    >
                        {({ errors, touched, values, handleChange, handleBlur }) => (
                            <Form autoComplete='off'>
                                ...
                                <div className="form-group">
                                    <label htmlFor="PC"> Project Coordinator* </label>
                                    <select
                                        name='PC'
                                        id='PC'
                                        className='form-control input-default mt-2'
