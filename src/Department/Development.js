...
export const Development = () => {
    ...
    const [filteredData, setFilterddata] = useState([department.departmentUser]);
    ...
    const editHandler = (id) => {
        setEditData(department.departmentUser.filter((fl) => fl.id === id));
        setSelectedId(id);
        setIsPost(false);
        handleShow()
    };
                ...
                <div className="pagetitle">
                    ...
                    <nav>
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active">Development Team</li>
                            <li className="breadcrumb-item active">- Today : {current}</li>
                        </ol>
                        ...
                        {({ errors, touched, values, handleChange, handleBlur }) => (
                            <Form autoComplete='off'>
                                <div className="form-group">
                                    <label htmlFor="Project"> Developer Name </label>
                                    <select
                                        name='user'
                                        id='user'
